...
// Mock Data - Enhanced with more realistic agricultural data
const mockFarmData = {
...
export default function FarmDashboard() {
  ...
  const [selectedField, setSelectedField] = useState(mockFarmData.currentField);
  ...
  const selectedFieldData = mockFarmData.fields.find(f => f.id === selectedField);
  ...
  return (
    <div className="flex h-screen bg-gradient-to-br from-green-50 via-emerald-50 to-teal-50 overflow-hidden">
        ...
        <div className="p-4 border-b border-gray-200">
          {isSidebarOpen && (
            <div className="mb-4">
              ...
              <p className="font-semibold text-gray-800">{mockFarmData.farmName}</p>
              {userLocation && (
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        {/* Header */}
        <header className="bg-white/90 backdrop-blur-sm border-b border-gray-200 p-4 flex justify-between items-center">
        ...
        <div className="flex-1 overflow-auto p-6">
            ...
            <div className="space-y-6">
              ...
              <Card title="Field Analysis" action={
                ...
                <div className="mt-4 grid grid-cols-2 gap-4">
                  <div className="text-center">
                    <div className="text-2xl font-bold text-green-600">{mockFarmData.stats.healthIndex}/100</div>
                    <div className="text-sm text-gray-600">Health Index</div>
                    <ProgressBar value={mockFarmData.stats.healthIndex} className="mt-2" />
                  </div>
                  <div className="text-center">
                    <div className="text-2xl font-bold text-blue-600">{mockFarmData.stats.ndvi}</div>
                    <div className="text-sm text-gray-600">NDVI Score</div>
                    <ProgressBar value={mockFarmData.stats.ndvi * 100} color="blue" className="mt-2" />
                  </div>
                </div>
              </Card>
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                <Card className="text-center">
                  <div className="flex items-center justify-center mb-2">
                    ...
                    <span className={`text-xl font-bold ${mockFarmData.stats.soilMoisture < 60 ? "text-red-600" : "text-blue-600"}`}>
                      {mockFarmData.stats.soilMoisture}%
                    </span>
                  </div>
                ...
                <Card className="text-center">
                  <div className="flex items-center justify-center mb-2">
                    ...
                    <span className="text-xl font-bold text-orange-600">{mockFarmData.stats.temperature}°C</span>
                  </div>
                ...
                <Card className="text-center">
                  <div className="flex items-center justify-center mb-2">
                    <AlertTriangle className={`mr-2 ${mockFarmData.stats.pestRisk === "High" ? "text-red-500" : mockFarmData.stats.pestRisk === "Medium" ? "text-yellow-500" : "text-green-500"}`} size={20} />
                    <span className={`text-xl font-bold ${mockFarmData.stats.pestRisk === "High" ? "text-red-600" : mockFarmData.stats.pestRisk === "Medium" ? "text-yellow-600" : "text-green-600"}`}>
                      {mockFarmData.stats.pestRisk}
                    </span>
                  </div>
                ...
                <Card className="text-center">
                  <div className="flex items-center justify-center mb-2">
                    ...
                    <span className="text-xl font-bold text-gray-700">{mockFarmData.stats.precipitation}mm</span>
                  </div>
              ...
              <Card title="5-Day Weather Forecast">
                <div className="grid grid-cols-5 gap-2">
                  {mockFarmData.weatherForecast.map((day, index) => (
              ...
              <Card title="Recent Alerts" action={
                ...
                <div className="space-y-3">
                  {mockFarmData.alerts.slice(0, 3).map(alert => (
          ...
          {/* Other tabs */}
          {!['overview', 'weather'].includes(selectedTab) && (
            <Card>
              <h3 className="text-lg font-semibold mb-4">{selectedTab.charAt(0).toUpperCase() + selectedTab.slice(1)} View</h3>
              <p className="text-gray-600">This section is under development. Detailed {selectedTab} analytics coming soon.</p>
            </Card>
          )}
        </div>
      </div>
